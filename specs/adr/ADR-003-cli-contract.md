...
## Decision
1. For the Foundation + Workstation MVP, implementation uses **Bash 4+** (`set -Eeuo pipefail`) to ensure zero external language runtime requirements on a fresh macOS machine.
